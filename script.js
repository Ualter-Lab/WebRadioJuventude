    ...
    const contacts = [
        {
            type: "community",
            phone: "5582991499935",
            message: "Olá! Gostaria de enviar uma notícia para a Web Rádio Juventude.",
...
Se você tem uma empresa, serviço, evento ou campanha para divulgar, oferecemos espaços de publicidade para conectar sua marca com um público local, ativo e engajado.`
    ...
    function renderContact(direction = 1) {
        ...
        window.setTimeout(() => {
            ...
            previousButton.classList.toggle("is-business", contact.type === "business");
    ...
    if ("IntersectionObserver" in window) {
        const revealItems = document.querySelectorAll(".card1, .card2, .card3, .letreiro, .card4, footer, .subcards > div");
